...
Item* Newspaper_Build()
{
	...
	return Item_Create("newspaper", "After close inspection with the ragged newspaper, you determine that millions of people fell unconscious aproximately five years ago. You also examine a small political cartoon of whatever.\n", true, NULL, Newspaper_Take, NULL, Newspaper_Read, NULL, NULL);
}