...
Brief Description:
This file defines the "map" Item in the game
...
void Map_Read(CommandContext context, GameState* gameState, WorldData* worldData)
{
	...
	Item* map; /* The brick in the player's inventory */
	...
	{
		/* the user doesn't have the map - inform the user of the problem and take no action */
		printf("\n");
		return;
	}
	else
	{
		...
		map = ItemList_FindItem(gameState->inventory, "map");

		/* Tell the user what they did */
		printf("The map explains that there is a subway system to the right of the park, and connects to times square and other buildings like a hospital.\nDandy\n");
