...
Room* Room0_Build()
{
	...
	printf("you wake up in the middle of a dirt feild ,theres noting here it's a dirt you can only go north/n")
...
Room* Room1_Build()
{
	...
	printf("YOU FIND YOUR SELF IN WHAT SEEMS TO BE A PARK BUT SOME OF THE PLANTS AND TREES ARE DEAD/N")
