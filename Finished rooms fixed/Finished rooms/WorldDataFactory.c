...
Room* DirtField_Build()
{
	...
	Room_Create("You open your eyes. You are in a large field, which becomes easier to make out as your head clears. You stand up and gaze upon the stretch of grass, noticing lumps of dirt at equal intervals along the land. A working fountain catches your eye to the north.");
...
Room* Alley_Build()
{
	...
	Room_Create("You walk into the dark alley. You see a shadow behind you. LOL its your own. Almost had a heart attack right there. There is a grocery store to the west and a drugstore to the north");
...
Room* GroceryStore_Build()
{
	...
	Room_Create("You walk into the grocery store.  There is a rotten fuji apple on the ground. Behind the cashier booth is a sledgehammer.");
...
Room* DrugStore_Build()
{
	...
	Room_Create("You enter the drugstore. You see a bunch of opened medicine bottles. It look like no one has been here in ages. A ticket on the ground catches your eyes.");
...
Room* Subway_Build()
{
	...
	Room_Create("You walk into the subway station. You find a pair of track shoes on the ground. Do you take them? ha ha they are size 13 mens. You hear very faintly in the distance Eee ERR.  A ticket booth is in front of you.");
...
Room* Hospital_Build()
{
	...
	Room_Create("You walk into the hospital. A clown car is parked outside. There is a lab coat hanging up on the wall. A piece of paper is on the receptionist's desk. There is also a door on the north wall labeled \"lab\".");
...
Room* Lab_Build()
{
	...
	Room_Create("You walk into the lab. You find a ton of CD's labbeled Ethans grovey jams. There is a syringe on the table, and a keycard on a adjacent one. To the east is a door to a secure area that you've been through many times before.");
...
Room* Apartment_Build()
{
	...
	Room_Create("You walk into your apartment. You see vancover titans posters all over the wall. what a werido. There is a computer on your desk.");
