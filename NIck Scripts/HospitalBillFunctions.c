...
void HospitalBill_Take(CommandContext context, GameState* gameState, WorldData* worldData)
{
	...
	printf("The bill appears to be untouched as it was printed just now.\n");
}
...
void HospitalBill_Read(CommandContext context, GameState* gameState, WorldData* worldData)
{
	...
	printf("After further inspection of the bill, it appears that the cost is 1 million dollars for a drug called b.r.a.i.n.  \n ");
}

Item* HospitalBill_Build()
{
	/* Create a "Hospital Bill" item, using the functions defined in this file */
	return Item_Create("hospital bill", "Your name is on the bill for an experamental drug called b.r.a.i.n.\n", true, NULL , HospitalBill_Take, NULL, HospitalBill_Read, NULL, NULL );
}