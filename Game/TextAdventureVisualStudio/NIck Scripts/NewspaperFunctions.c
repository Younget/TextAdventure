...
void Newspaper_Read(CommandContext context, GameState* gameState, WorldData* worldData)
{
	...
	printf("After close inspection with the ragged newspaper, you determine that millions of people fell unconscious aproximately five years ago. You also examine a small political cartoon of whatever. You also see several articles of people claiming that the disease is fake news and it was created by the russians to spread communism. \n");
}
